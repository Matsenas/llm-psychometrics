...
const FeedbackIntro = () => {
  ...
  }, [isLoading, participant, activeStudy, checkingAdmin, isAdmin]);
          ...
          <CardContent className="space-y-6">
            <div className="prose prose-sm max-w-none text-muted-foreground">
              <p className="text-center">
                You've completed both the AI conversations and the self-report questionnaire. One last step remains!
              </p>
            </div>
